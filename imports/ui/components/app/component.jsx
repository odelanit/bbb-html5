    ...
    render() {
        ...
        return (
            <main>
                                                    ...
                                                    <div className="media w-50 mb-3"><img
                                                        ...
                                                        <div className="media-body ml-3">
                                                            <div className="bg-light rounded py-2 px-3 mb-2">
                                                                <p className="text-small mb-0 text-muted">Test which is
                                                                    a new approach
                                                                    all
                                                                    solutions</p>
                                                            </div>
                                                    ...
                                                    <div className="media w-50 ml-auto mb-3">
                                                        <div className="media-body">
                                                            <div className="bg-primary rounded py-2 px-3 mb-2">
                                                                <p className="text-small mb-0 text-white">Test which is
                                                                    a new approach
                                                                    to have all
                                                                    solutions</p>
                                                            </div>
                                        ...
                                        {this.props.isInviteBox && (
                                            <div className="px-4 py-5 chat-box chat-box-h bg-white">
                                                ...
                                                <div className="input-group call-inv">
                                                    ...
                                                    <input className="form-control py-2 border-left-0 border call-invi"
                                                           type="search"
                                                           value="Invite someone" id="example-search-input"/>

                                                </div>
                                                <div className="media w-50 mb-3 call-in-p"><img
                                                    src="https://res.cloudinary.com/mhmd/image/upload/v1564960395/avatar_usae7z.svg"
                                                    alt="user" width="50" className="rounded-circle"/>
                                                    <div className="media-body ml-3">
                                                        <div className="rounded py-2 mb-2">
                                                            ...
                                                            <div className="row">
                                                                <div className="col-md-8">
                                                                    <p className="text-small mb-0 text-muted">Sr. UX
                                                                        Designer, New York</p>
                                                                </div>
                ...
                {customStyle ? <link rel="stylesheet" type="text/css"
                                     href={`data:text/css;charset=UTF-8,${encodeURIComponent(customStyle)}`}/> : null}
            </main>
        );
    }
}
