...
class SettingsDropdown extends PureComponent {
    ...
    renderMenuItems() {
        ...
        return _.compact([
            ...
            !helpButton ? null
                : (<a className="navbar-item" key="list-item-shortcuts"
                      onClick={() => window.open(`${helpLink}`)}>
                    <i className="far fa-question-circle mr-2"/>
                    {intl.formatMessage(intlMessages.hotkeysLabel)}
                </a>),
            (<a className="navbar-item" key="list-item-shortcuts" onClick={() => mountModal(<ShortcutHelpComponent/>)}>
                <i className="far fa-question-circle mr-2"/>
                {intl.formatMessage(intlMessages.hotkeysLabel)}
            </a>),
            ...
            allowedToEndMeeting && isMeteorConnected
                ? (
                    <a className="navbar-item" key="list-item-end-meeting"
        ...
        return (
            <li className="navbar-item has-dropdown is-hoverable">
                ...
                <div className="navbar-dropdown is-right">
                    ...
                    {/*    <i className="fas fa-cogs mr-2 text-gray-400"/>*/}
                    {/*    Settings*/}
                    {/*</a>*/}

                    {/*<a className="navbar-item" href="#">*/}
                    {/*    <i className="fas fa-list mr-2 text-gray-400"/>*/}
                    {/*    About*/}
                    {/*</a>*/}
                    {/*<div className="navbar-divider"/>*/}
                    {/*<a className="navbar-item">*/}
                    {/*    <i className="fas fa-window mr-2 text-gray-400"/>*/}
                    {/*    End meeting*/}
                    {/*</a>*/}
                    {/*<a className="navbar-item">*/}
                    {/*    <i className="fas fa-sign-out-alt mr-2 text-gray-400"/>*/}
                    {/*    {intl.formatMessage(intlMessages.endMeetingLabel)}*/}
                    {/*</a>*/}
                </div>
            </li>
